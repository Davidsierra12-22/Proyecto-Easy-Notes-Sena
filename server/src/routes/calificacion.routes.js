...
router.post('/masivo', protect, writeLimiter, authorize(...PERMISOS.DOCENTE), registrarAccion('crear_calificacion_masiva', 'Calificaciones'), controller.guardarNotas);
...
router.post('/', protect, writeLimiter, authorize(...PERMISOS.DOCENTE), registrarAccion('crear_calificacion', 'Calificaciones'), controller.create);
router.put('/:id', protect, reglas.idMongo, validar, writeLimiter, authorize(...PERMISOS.DOCENTE), registrarAccion('editar_calificacion', 'Calificaciones'), controller.update);
