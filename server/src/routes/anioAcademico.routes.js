...
router.post('/', writeLimiter, authorize(...PERMISOS.ACADEMICO), registrarAccion('crear_año_academico', 'AniosAcademicos'), controller.create);
router.put('/:id', reglas.idMongo, validar, writeLimiter, authorize(...PERMISOS.ACADEMICO), registrarAccion('editar_año_academico', 'AniosAcademicos'), controller.update);
