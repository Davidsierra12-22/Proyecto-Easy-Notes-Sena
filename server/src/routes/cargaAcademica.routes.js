...
router.post('/', writeLimiter, authorize(...PERMISOS.GESTION), registrarAccion('crear_carga_academica', 'CargaAcademica'), controller.create);
router.put('/:id', reglas.idMongo, validar, writeLimiter, authorize(...PERMISOS.GESTION), registrarAccion('editar_carga_academica', 'CargaAcademica'), controller.update);
