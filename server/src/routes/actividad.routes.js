...
router.post('/', protect, verificarPeriodoAbierto, authorize(...PERMISOS.DOCENTE), controller.create);
router.put('/:id', protect, reglas.idMongo, validar, verificarPeriodoAbierto, authorize(...PERMISOS.DOCENTE), controller.update);
